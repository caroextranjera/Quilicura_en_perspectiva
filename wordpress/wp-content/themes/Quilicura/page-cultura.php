  ...
  galery.innerHTML += ` 
                       <div class="card">
                        <a href="#" data-toggle="modal" data-target="#id${imagen}">
                          <img class="galeria img-responsive" src="<?php echo get_theme_file_uri() ?>/img-cultura/${imagen}.jpg" class=" img-fluid galeria">
                        </a>
                       </div>
                        <div class="modal fade" id="id${imagen}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                           <img   src="<?php echo get_theme_file_uri() ?>/img-cultura/${imagen}.jpg" class="img-fluid rounded">
                         </div>
                      </div> `
}
