...
add_action( 'init', 'Cultura', 0 );

// Register Custom Post Type
function Inicio_dos() {

	$labels = array(
		'name'                  => _x( 'segundos', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'segundo', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Inicio-dos', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
	...
	register_post_type( 'Inicio-dos', $args );

}
add_action( 'init', 'Inicio_dos', 0 );


// Register Custom Post Type
function Inicio_tercero() {

	$labels = array(
		'name'                  => _x( 'terceros', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'tercero', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Inicio-tercero', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
	...
	register_post_type( 'Inicio-tercero', $args );

}
add_action( 'init', 'Inicio_tercero', 0 );

// Register Custom Post Type
function Inicio_cuarto() {

	$labels = array(
		'name'                  => _x( 'cuartos', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'cuarto', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Inicio-cuarto', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
	...
	register_post_type( 'Inicio-cuarto', $args );

}
add_action( 'init', 'Inicio_cuarto', 0 );
...
function Deporte() {
	...
	$labels = array(
		'name'                  => _x( 'deportes', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'deporte', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Deporte', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
...
add_action( 'init', 'Deporte', 0 );

// Register Custom Post Type
function Capacitaciones() {

	$labels = array(
		'name'                  => _x( 'capacitaciones', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'capacitacion', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Capacitaciones', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'capacitacion', 'text_domain' ),
		'description'           => __( 'Post Type Description', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
	...
	register_post_type( 'Capacitaciones', $args );

}
add_action( 'init', 'Capacitaciones', 0 );
